...
# Install R packages
RUN R -e 'install.packages(c("irlba","igraph","ggplot2","digest","lattice","XML","Rcpp","reshape2","plyr","stringi","stringr","intervals","devtools","RColorBrewer","plyr","RANN","knitr","ncdf4","microbenchmark","RUnit","foreach","doMC","curl","jsonlite","treemap","colourpicker","htmltools","shiny","shinyBS","shinyjs","DT","FactoMineR","slam","cba","squash","plotrix","plotly","circlize","matrixStats","Matrix","tools","ape","data.tree","plyr","data.table","kableExtra","htmlwidgets","sunburstR","SparseM","ROCR","PRROC","klaR","e1071","kohonen","nnet","rda","caret","caretEnsemble","RCurl","ontologyIndex","party","entropy","binda","MLmetrics","doMC"), repos="https://cloud.r-project.org/")'
